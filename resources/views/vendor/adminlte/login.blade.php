...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}">{!! config('adminlte.logo', '<b>Protyasha
                Web</b>')
            !!}</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{ url(config('adminlte.login_url', 'login')) }}" method="post">
            ...
            <div class="form-group has-feedback {{ $errors->has('user_name') ? 'has-error' : '' }}">
                <input type="user_name" name="user_name" class="form-control" value="{{ old('user_name') }}"
